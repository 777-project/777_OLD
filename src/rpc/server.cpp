...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    StartShutdown();
    return "Jackpot server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* PIVX features */
        {"jackpot", "listmasternodes", &listmasternodes, true, true, false},
        {"jackpot", "getmasternodecount", &getmasternodecount, true, true, false},
        {"jackpot", "masternodeconnect", &masternodeconnect, true, true, false},
        {"jackpot", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"jackpot", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"jackpot", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"jackpot", "masternodecurrent", &masternodecurrent, true, true, false},
        {"jackpot", "masternodedebug", &masternodedebug, true, true, false},
        {"jackpot", "startmasternode", &startmasternode, true, true, false},
        {"jackpot", "createmasternodekey", &createmasternodekey, true, true, false},
        {"jackpot", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"jackpot", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"jackpot", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"jackpot", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"jackpot", "getmasternodescores", &getmasternodescores, true, true, false},
        {"jackpot", "preparebudget", &preparebudget, true, true, false},
        {"jackpot", "submitbudget", &submitbudget, true, true, false},
        {"jackpot", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"jackpot", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"jackpot", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"jackpot", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"jackpot", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"jackpot", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"jackpot", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"jackpot", "checkbudgets", &checkbudgets, true, true, false},
        {"jackpot", "mnsync", &mnsync, true, true, false},
        {"jackpot", "spork", &spork, true, true, false},
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:27772/\n";
}
