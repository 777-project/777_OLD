    ...
    btnContacts(new QPushButton())
{
    ...
    /* Subtitle */
    ui->labelSubtitle1->setText(tr("You can transfer 777"));
    setCssProperty(ui->labelSubtitle1, "text-subtitle");

    /* Address */
    ui->labelSubtitleAddress->setText(tr("777 address or contact label"));
    ...
    ui->labelAmountSend->setText("0.00 777");
...
void SendWidget::refreshView()
{
    ...
    ui->pushButtonSave->setText(tr("Send 777"));
...
void SendWidget::showHideCheckBoxDelegations()
{
    ...
    // coincontrol is not selected, and we are trying to spend 777 (not zRPD)
