    ...
    ui(new Ui::DashboardWidget)
{
    ...
    ui->labelMessage->setText(tr("Amount of 777 earned via Staking & Masternodes"));
    ...
    ui->labelAmountPiv->setText("0 777");
	ui->labelAmountMNRewards->setText("0 777");
...
void DashboardWidget::onChartRefreshed()
{
    ...
    // init sets
    set0 = new QBarSet("777");
	set1 = new QBarSet("777 MN Rewards");
