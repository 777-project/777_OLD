...
void setupAddressWidget(QValidatedLineEdit* widget, QWidget* parent)
{
    ...
    widget->setPlaceholderText(QObject::tr("Enter 777 address (e.g. %1)").arg("7mphVWRT43hdZ9zncvPRgA94tuL2dvFXCL"));
...
{
    // return if URI is not valid or is no 777: URI
...
bool openConfigfile()
{
    ...
    /* Open jackpot.conf with the associated application */
...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "Jackpot.lnk";
}
...
{
    return GetAutostartDir() / "jackpot.desktop";
}
